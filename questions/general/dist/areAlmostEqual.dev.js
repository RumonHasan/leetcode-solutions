...
var areAlmostEqual = function areAlmostEqual(s1, s2) {
  ...
  try {
    for (var _iterator2 = sOne[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
