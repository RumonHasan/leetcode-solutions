...
var shortestCompletingWord = function shortestCompletingWord(licensePlate, words) {
  var isLetter = function isLetter(_char) {
    return /^[a-zA-Z]$/.test(_char);
  };

  var array = licensePlate.split('').filter(function (possible_letter) {
    return isLetter(possible_letter);
  }).map(function (letter) {
