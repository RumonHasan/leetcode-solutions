...
var sentenceSimilarity = function sentenceSimilarity(sentence1, sentence2) {
  ...
  var s1Suff = s1.length - 1;
  var s2Suff = s2.length - 1;
...
console.log(sentenceSimilarity('Hello I Good I Hello Good Jane', 'Hello Good Jane'));